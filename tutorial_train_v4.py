        ...
        for step, batch in enumerate(train_dataloader):
            ...
            for i in range(args.gradient_accum_step):
                ...
                with accelerator.accumulate(clip_model, ip_adapter):
                    ...
                    loss = mse_loss * 1e-3
                    # loss = mse_loss * loss_scale_list[epoch]
            ...
            accelerator.log(
                {
                    ...
                    # "ip-adapter/loss_scale": loss_scale_list[epoch],
                    "ip-adapter/loss_scale": 1e-3,
                    # "ip-adapter/param_loss_scale": clip_model.module.mse_loss_scale.item(),
                },
                step=step,
            )
            # accelerator.log(
            ...
            if accelerator.is_main_process and step % 20 == 0:
                ...
                # )
                print(
                    # "Global_Step {}, Epoch {}, step {}, time: {}, mean_timestep: {}, step_loss: {}, mse_loss: {}, loss_scale: {}, time_passed: {}".format(
                    "Global_Step {}, Epoch {}, step {}, time: {}, mean_timestep: {}, step_loss: {}, mse_loss: {}, loss_scale:{}, time_passed: {}".format(
                        global_step,
                        epoch,
                        step,
                        ...
                        loss,
                        mse_loss,
                        # loss_scale_list[epoch],
                        1e-3,
                        # clip_model.module.mse_loss_scale.item(),
                        timedelta(seconds=(time.time() - start_time)),
                    )
                )
                begin = time.perf_counter()
