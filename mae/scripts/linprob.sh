...
MODEL_NAME="finetuned-clip_full_image-only_imagenet100_timestep-400-600_clip-loss-ratio-0.999_epoch-2"
...
CKPT_PATH=/scratch/choi/output/Diff-Rep/ViT-H/ip-adapter/full_image-text_imagenet100_timestep-400-600_clip-loss-ratio-0.0_06-17_15:48/checkpoint_10560-step_2-epoch
