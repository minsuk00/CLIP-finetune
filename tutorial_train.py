...
def main():
    ...
    if args.resume_path!="_":
        ...
        args.output_dir += f"/{args.train_type}_{args.train_modality}_{args.dataset_type}_timestep-{args.timestep}_clip-loss-ratio-{args.clip_loss_ratio}_{datetime.now().strftime("%m-%d_%H:%M")}"
